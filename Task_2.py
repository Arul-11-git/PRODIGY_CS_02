...
start1 = tk.Label(text="Image Encryption\nDecryption", font=("Arial", 20), fg="magenta")
start1.place(x=350, y=10)

start1 = tk.Label(text="Original\nImage", font=("Arial", 20), fg="magenta")
start1.place(x=100, y=80)

start1 = tk.Label(text="Encrypted/Decrypted\nImage", font=("Arial", 20), fg="magenta")
start1.place(x=700, y=80)

chooseb = Button(window, text="Choose", command=open_img, font=("Arial", 16), bg="orange", fg="blue", borderwidth=3, relief="raised")
chooseb.place(x=30, y=20)

saveb = Button(window, text="Save", command=save_img, font=("Arial", 16), bg="orange", fg="blue", borderwidth=3, relief="raised")
saveb.place(x=170, y=20)

enb = Button(window, text="Encrypt", command=lambda: en_fun(x), font=("Arial", 16), bg="light green", fg="blue", borderwidth=3, relief="raised")
enb.place(x=150, y=620)

deb = Button(window, text="Decrypt", command=de_fun, font=("Arial", 16), bg="orange", fg="blue", borderwidth=3, relief="raised")
deb.place(x=450, y=620)

resetb = Button(window, text="Reset", command=reset, font=("Arial", 16),  fg="blue", borderwidth=3, relief="raised")
...
exitb = Button(window, text="EXIT", command=exit_win, font=("Arial", 16), fg="blue", borderwidth=3, relief="raised")
